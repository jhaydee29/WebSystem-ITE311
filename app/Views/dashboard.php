    ...
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                $hour = date('H');
                if ($hour < 12) {
                    echo "Good morning! Ready to learn something new?";
                } elseif ($hour == 12) {
                    echo "Good noon! Perfect time for some learning.";
                } elseif ($hour < 18) {
                    echo "Good afternoon! How's your day going?";
                } else {
                    echo "Good evening! Time to catch up on your courses.";
                }
                ?>
            </p>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="activity-list">
                        <div class="activity-item mb-2">
                            ...
                            <small>Check out the new materials uploaded in your courses!</small>
                        </div>
                        <div class="activity-item mb-2">
                            <i class="fas fa-fire text-danger me-2"></i>
                            <small>Keep up the good work! You're doing great this semester.</small>
                        </div>
                        <div class="activity-item mb-2">
                            <i class="fas fa-lightbulb text-warning me-2"></i>
                            <small>Tip: Download course materials early to stay ahead</small>
                        </div>
                        <div class="activity-item mb-2">
